 ...
 * Primero llama a la función ft_putstr_fd para escribir la cadena de caracteres.
 * Luego llama a la función ft_putchar_fd para escribir un salto de línea.
 *
 * @param s: La cadena de caracteres a escribir.
 * @param fd: El descriptor de archivo donde escribir la cadena de caracteres y el salto de línea.
 */
