 ...
 * Utiliza la función write del sistema operativo para escribir la cadena de caracteres.
 * La longitud de la cadena de caracteres se obtiene con la función ft_strlen.
 *
