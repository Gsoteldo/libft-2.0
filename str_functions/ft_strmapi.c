...
/**
 * Aplica una función dada a cada carácter de una cadena de caracteres junto con su índice y devuelve una nueva cadena de caracteres con los resultados.
 ...
 * Aplica la función dada a cada carácter de la cadena de caracteres original junto con su índice y guarda el resultado en la nueva cadena de caracteres.
 ...
 * @return: Nueva cadena de caracteres con los resultados de aplicar la función a cada carácter de la cadena de caracteres original, o nulo si la asignación de memoria falló.
 */
