 ...
 * Si la lista está vacía, establece el nuevo nodo como el primer nodo de la lista.
 * Si la lista no está vacía, establece el campo `next` del último nodo para apuntar al nuevo nodo.
 *
